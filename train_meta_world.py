...
def experiment(
    ...
    for name, env_cls in ml45.train_classes.items():
        if name == meta_world_game_list[0]:
            env = env_cls()
    ...
    # load dataset
    dataset_path = f'data_success/{env_name}-v2_full.pkl'
    ...
    def eval_episodes(target_rew):
        def fn(model):
            ...
            return {
                ...
                f'success_rate': float(success/20),
            }
        return fn
...
if __name__ == '__main__':
    ...
    parser.add_argument('--env', type=str, default='basketball')
