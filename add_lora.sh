###
 ...
 # @LastEditTime: 2023-05-09 08:57:10
 # @LastEditors: Jikun Kang
 # @FilePath: /Hyper-DT/add_lora.sh
### 
...
python train.py --create_hnet=$create_hnet --max_epochs=21 --eval_freq 10 --n_embd=512 --n_layer=4 --use_wandb=$use_wandb\
